            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">University-Wide Services</p>
                        <h1 class="fw-bold">The best solution for your Problems</h1>
                    </div>
                </div>
                    ...
                    <div class="col mb-4">
                        <div class="card bg-primary-subtle">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3"><span style="font-weight: normal !important;">You will be able to Reserve time slots and save your valuable time</span></h5><button class="btn btn-primary btn-sm" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card bg-secondary-subtle">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3"><span style="font-weight: normal !important;">Order products without walking miles</span></h5><button class="btn btn-secondary btn-sm" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card bg-info-subtle">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title mb-3"><span style="font-weight: normal !important;">Find the most suitable people to handover your work</span></h5><button class="btn btn-info btn-sm" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                </div>
