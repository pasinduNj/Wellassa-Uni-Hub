  ...
  <nav class="navbar navbar-expand-md sticky-top text-nowrap shadow visible navbar-shrink py-3 navbar-light"
    ...
    <div class="container">
      <span
        ...
        </svg></span><a class="navbar-brand d-flex align-items-center" href="/"><span>Wellassa UniHUB</span></a><button
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown" style="margin: 0px; padding: -1px">
            <a class="dropdown-toggle nav-link d-lg-flex align-items-lg-center" aria-expanded="false"
              data-bs-toggle="dropdown" href="Reservations.html" target="_blank" style="
                  margin: -1px;
                  padding: 9px;
                  font-weight: bold;
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="Reservations.html">Reservations</a><a class="dropdown-item"
                href="Shop.html">Order Products</a><a class="dropdown-item" href="freelance.php">Freelance</a>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Service%20Provider.html"
              style="margin: 0px; padding: 8px; height: 36.6px">Profile</a>
          </li>
        </ul>
        <a class="btn btn-primary shadow" role="button" href="login.php" style="
              height: 35px;
              padding: 3px 10px;
          ...
          role="button" href="shopping-cart.html" style="
              padding: 1px;
              padding-left: 11px;
              margin: 0px;
              margin-left: 7px;
