...
<body>
    <nav class="navbar navbar-expand-md sticky-top text-nowrap shadow visible navbar-shrink py-3 navbar-light" id="mainNav" style="background: url(&quot;https://cdn.bootstrapstudio.io/placeholders/1400x800.png&quot;), linear-gradient(black, white), var(--bs-body-bg);height: 73.2px;color: var(--bs-body-bg);--bs-body-bg: var(--bs-tertiary-bg);" data-bs-smooth-scroll="true">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-gear-wide">
                    ...
                    </svg></span><span>Wellassa UniHUB</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle
                    navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2" style="--bs-body-bg: #ffffff;">
                ...
                </ul><a class="btn btn-primary shadow" role="button" href="signup.php" style="height: 42.4px;padding: 7.6px 32px;margin: 20px;">Sign up</a><a class="font-monospace link-warning border-white d-inline-block float-end d-lg-flex align-items-lg-center pull-right" role="button" href="shopping-cart.php" style="padding-left: 11px;margin-left: 7px;margin-right: 5px;margin-bottom: 3px;padding-bottom: 7px;padding-top: 7px;padding-right: 12px;margin-top: 1px;transform: translate(24px) rotate(1deg) scale(1);box-shadow: 0px 0px;"><i class="fa fa-shopping-cart"></i>&nbsp;Cart</a>
            </div>
        </div>
    </nav>
    <div style="height: 701px;background: url(&quot;assets/img/b2b-service-pages.webp&quot;) center / cover no-repeat;">
        <div class="d-flex justify-content-center align-items-center" style="height:inherit;min-height:initial;width:100%;position:absolute;left:0;background-color:rgba(30,41,99,0.53);">
            <div class="d-flex align-items-center order-5" style="height:200px;">
                <div class="container">
                    <h1 class="text-center" style="color: rgb(242,245,248);font-size: 56px;font-weight: bold;font-family: 'ADLaM Display', serif;background: rgba(255,255,255,0.17);border-radius: 13px;text-align: center;border-style: solid;">
                        <span style="color: rgb(255, 255, 255);">&nbsp; All the services you need in one
                            place&nbsp;</span>
                    </h1>
                    <h3 class="text-center" style="color: rgb(242,245,248);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;background: rgba(255,255,255,0.16);border-radius: 14px;border-style: solid;font-family: 'ADLaM Display', serif;">
                        University wide services</h3>
                </div>
            </div>
        </div>
    </div>
