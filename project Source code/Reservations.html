                ...
                <div class="row filtr-container">
                    <div class="col-md-6 col-lg-4 filtr-item" data-category="2,3">
                        <div class="card border-dark">
                            <div class="card-header bg-dark text-light">
                                <h5 class="m-0">Hair Saloon</h5>
                            </div><img class="img-fluid card-img w-100 d-block rounded-0" src="assets/img/man--8765248_1280.jpg">
                            <div class="card-body">
                                <div class="jumbotron" style="padding:15px" hovertext="This is the awesome example! Maybe small but very effective if you use it on texts, buttons or links!">
                                    <p style="height: 16.8px;"><br>Location : Students'&nbsp; Center&nbsp;<br><br></p>
                                    <p style="height: 26.2px;"><br>Done by : Sadun</p>
                                </div>
                            </div>
                            <div class="d-flex card-footer" style="height: 58.8px;padding: 93px 16px;"><a class="btn btn-dark btn-sm" role="button" href="Haircut%20reserve.html" style="height: 39.8px;width: 433.225px;"><span style="font-weight: normal !important;">Reserve</span></a></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 filtr-item" data-category="1,3">
                        <div class="card border-dark">
                            <div class="card-header bg-dark text-light">
                                <h5 class="m-0">Makeup Artist</h5>
                            </div><img class="img-fluid card-img w-100 d-block rounded-0" alt="lipstick, cosmetics, woman" src="assets/img/gc32ebd5d0a5f2684e989300b71259331e3025500f09890237dea629b85a1b2e53ed9d120d62e7b07f72d5d07f9068a5ad88ead7f993c1e67418bdd9c3c0bfa4c_640.jpg">
                            <div class="card-body">
                                <div class="jumbotron" style="padding: 15px;height: 111px;" hovertext="This is the awesome example! Maybe small but very effective if you use it on texts, buttons or links!">
                                    <p style="height: 16.8px;"><br>Location : As preferred<br><br></p>
                                    <p style="height: 26.2px;"><br>Done by: Mandira</p>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex card-footer" style="height: 58.8px;padding: 93px 16px;"><a class="btn btn-dark btn-sm" role="button" href="Haircut%20reserve.html" style="height: 39.8px;width: 433.225px;"><span style="font-weight: normal !important;">Reserve</span></a></div>
                    ...
                    <div class="col-md-6 col-lg-4 filtr-item" data-category="2,3">
                        <div class="card border-dark">
                            ...
                            </div><img class="img-fluid card-img w-100 d-block rounded-0" alt="eyeliner, makeup, beauty" src="assets/img/g84271c9e94536080d8ec55c88025f401f492c9ed26a3795b4aaaa458ad4ff3f9ee65ba31bae0e3914e2991ae3293bb3964658a5f3ce9265aa584bf477416c9d7_640.jpg">
                            <div class="card-body">
                                <div class="jumbotron" style="padding: 15px;height: 111px;" hovertext="This is the awesome example! Maybe small but very effective if you use it on texts, buttons or links!">
                                    <p style="height: 16.8px;"><br>Location : As preferred<br>Done by : Gorden</p>
                                    <p style="height: 26.2px;"><br><br></p>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex card-footer" style="height: 58.8px;padding: 93px 16px;"><a class="btn btn-dark btn-sm" role="button" href="Haircut%20reserve.html" style="height: 39.8px;width: 433.225px;"><span style="font-weight: normal !important;">Reserve</span></a></div>
                    ...
                    <div class="col-md-6 col-lg-4 filtr-item" data-category="3">
                        <div class="card border-dark">
                            ...
                            <div class="card-body">
                                <p class="card-text">Nullam id dolor id nibh ultricies vehicula ut id elit.&nbsp;Populique et auctoritate cum sint partes regina canities et circumspectum habkcak akbvkab arvakr arvbkae&nbsp;</p>
                            </div>
                        </div>
                        <div class="d-flex card-footer" style="height: 58.8px;padding: 93px 16px;"><a class="btn btn-dark btn-sm" role="button" href="Haircut%20reserve.html" style="height: 39.8px;width: 433.225px;"><span style="font-weight: normal !important;">Reserve</span></a></div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 filtr-item" data-category="1,3">
                        <div class="card border-dark">
                            ...
                            <div class="card-body">
                                <p class="card-text">Nullam id dolor id nibh ultricies vehicula ut id elit.&nbsp;Et admiratio incidere magis eo incidere et fsvrsesbcsvr avrf rge rgsergse ergs</p>
                            </div>
                        </div>
                        <div class="d-flex card-footer" style="height: 58.8px;padding: 93px 16px;"><a class="btn btn-dark btn-sm" role="button" href="Haircut%20reserve.html" style="height: 39.8px;width: 433.225px;"><span style="font-weight: normal !important;">Reserve</span></a></div>
                    </div>
