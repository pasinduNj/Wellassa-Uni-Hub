        ...
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          ...
          if (isset($_GET['S'])) {
            if ($_GET['S'] == '1') {
              ...
              echo '<div class="alert alert-success" role="alert">Check you email and log in with the provided Link within 10 minutes.</div>';
            } elseif ($_GET['S'] == '4') {
              echo '<div class="alert alert-danger" role="alert">Email send failed. Try Again</div>';
            } elseif ($_GET['S'] == '5') {
              echo '<div class="alert alert-danger" role="alert">Password Update Failed. Try Again</div>';
            } elseif ($_GET['S'] == '6') {
              echo '<div class="alert alert-danger" role="alert">Invalid Email or Contact Number</div>';
            } elseif ($_GET['S'] == '7') {
              echo '<div class="alert alert-danger" role="alert">Token Expired</div>';
            } elseif ($_GET['S'] == '8') {
              echo '<div class="alert alert-danger" role="alert">Invalid Token</div>';
            } elseif ($_GET['S'] == '9') {
              echo '<div class="alert alert-danger" role="alert">There is a Problem Try Again</div>';
            }
          }
