...
<body>
    ...
    <div class="main-content">
        <div class="container-form">
            ...
            if (isset($_GET['S'])) {
                if ($_GET['S'] == '1') {
                    echo '<div class="alert alert-success" role="alert"><center><h5>Timeslots Added Successfully</h5></center></div>';
                }
            }
            ?>
            <h2>Add Timeslots</h2>
            <form action="./php/add_timeslot_process.php" method="post" style="padding: 20px;">
